                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="dropdown custom-dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink-1"
                                        ...
                                        <a class="dropdown-item" href="{{ url('/dkn/prev-classes/' . $slug . '?pdf=1') }}"
                                ...
                                <table class="table table-bordered mb-4" id="table-list">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" colspan="{{ count($results['course']) }}">Pengetahuan</th>
                                            
                                            <th class="text-center" colspan="{{ count($results['course']) }}">Keterampilan</th>
                                            <th class="text-center" colspan="2">Sikap</th>
                                            <th class="text-center" colspan="2">Jumlah</th>
                                            <th rowspan="3" class="text-center">Jumlah Nilai</th>
                                            <th rowspan="3" class="text-center">Ranking</th>
                                        ...
                                        <tr>
                                            ...
                                            <th rowspan="2" class="text-center vertical-text rotate-text"><b>Spriritual</b></th>
                                            <th rowspan="2" class="text-center vertical-text rotate-text"><b>Sosial</b></th>

                                            <th class="text-center vertical-text rotate-text"><b>Pengetahuan</b></th>
                                            <th class="text-center vertical-text rotate-text"><b>Ketrampilan</b></th>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center"><b>YA</b></th>
                                            <th class="text-center"><b>YA</b></th>
