                    ...
                    <div class="info widget-content widget-content-area ecommerce-create-section">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_tema" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <option value="{{ $tema['id'] }}" {{ isset($p5) && old('id_tema', $p5->id_tema) ==
                                        $tema->id ? 'selected' : (old('id_tema') == $tema->id ? 'selected' : '') }}>
                                        {{ $tema['name'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" rows="3"
                                class="form-control">{{ isset($p5) ? old('description', $p5->description) : old('description') }}</textarea>
                        </div>
                        ...
                        <input type="hidden" name="id_subject_teacher"
                            value="{{ session('teachers.id_subject_teacher') }}">
                        @else
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_study_class" class="form-control">
                                    ...
                                    <option value="{{ $class->id }}" {{ isset($p5) && old('id_study_class', $p5->
                                        id_study_class) == $class->id ? 'selected' : (old('id_study_class') ==
                                        $class->id ? 'selected' : '') }}>
                                        {{ $class->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_subject_teacher" class="form-control selectpicker"
                                    ...
                                    <option value="{{ $teacher->id }}" {{ old('id_subject_teacher', $p5->
                                        id_subject_teacher) == $teacher->id ? 'selected' : '' }}>
                                ...
                                <div id="myGroup">
                                    ...
                                    <tr>
                                        ...
                                        <td class="pointer">
                                            ...
                                            <span class="badge badge-primary my-1 collapse-trigger"
                                                data-toggle="collapse" data-parent="#myGroup"
                                                data-target="#sub_element_{{ $elemen->id }}" aria-expanded="false"
                                                aria-controls="sub_element_{{ $elemen->id }}"> {{ $elemen->name }}
                                            </span>
                                            @endforeach
                                        </td>
                                    </tr>
                                    <tr>
                                        <div class="accordion-group">
                                            ...
                                            <td colspan="3" class="p-0">
                                                ...
                                                <div class="collapse" data-parent="#myGroup"
                                                    id="sub_element_{{ $element->id }}"
                                                    ...
                                                    <table class="table mb-0 table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if ($sub_element->id == $subElem->id_sub_element &&
                                                            $sub_element->id_dimension == $subElem->id_dimension) {
                                                            $isChecked = true;
                                                            break;
                                                            }
                                                            }
                                                            ...
                                                            <tr>
                                                                <td class="col-1" style="position: relative;">
                                                                    <input style="position:relative" type="checkbox"
                                                                        class="form-check-input" name="sub_element[]"
                                                                        value="{{ $sub_element->id }}-{{ $dimension->id }}"
                                                                        id="checkbox{{ $index }}" {{ $isChecked
                                                                        ? 'checked' : '' }}>
                                                                </td>
                                                        ...
                                                        <tr>
                                                            <td class="form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    name="sub_element[]"
                                                                    value="{{ $sub_element->id }}-{{ $dimension->id }}"
                                                                    id="checkbox{{ $index }}" {{ $isChecked ? 'checked'
                                                                    : '' }}>
                                                            </td>
                                                            <td>{{ $sub_element->name }}</td>
                                                        </tr>
