                                    ...
                                    <div class="form-group row my-auto mx-3">
                                        ...
                                        <div class="col">
                                            <select name="id_student" id="" class="form-control">
                                                ...
                                                <option value="{{ $student->slug }}" {{ $selectedStudentSlug==$student->
                                                    slug ? 'selected' : '' }}>
                                                    {{ $student->name }}</option>
                                                @endforeach
                                            </select>
                    ...
                    <div class="statbox widget box box-shadow">
                        <div class="info widget-content widget-content-area">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label for="nama_sekolah" class="col-form-label font-weight-bold">Nama
                                        Sekolah</label>
                                    <p class="form-control-plaintext">{{ $data['schoolName'] }}</p>
                                </div>
                                <div class="form-group col-md-3">
                                        ...
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    !isset($_GET['student']) ? 'disabled' : '' }}>
                                                <label class="form-check-label" for="sub_element_mulai"></label>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    !isset($_GET['student']) ? 'disabled' : '' }}>
                                                <label class="form-check-label" for="sub_element_berkembang"></label>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    !isset($_GET['student']) ? 'disabled' : '' }}>
                                                <label class="form-check-label" for="sub_element_sangat"></label>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" rows="3" class="form-control" {{ empty($_GET['student'])
                                    ? 'disabled' : ''
                                    }}>{{ !empty($_GET['student']) ? $data['description'] : '' }}</textarea>
                            </div>
                        </div>
