                ...
                <div class="col-xl-12 col-lg-12 col-sm-12 layout-top-spacing layout-spacing">
                    <div class="statbox widget box box-shadow">
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12 d-flex justify-content-between  mt-2">
                                    <h4>{{ session('title') }}</h4>
                                    <form action="{{ route('templates.defaultsave') }}" method="post" class="formtest">
                                        @csrf
                                        <div class="row  my-auto">
                                            <div class="col-lg-4">
                                                <select name="template_type" class="form-control">
                                                    <option value="" selected disabled>-- Pilih Tipe Template --
                                                    </option>
                                                    <option value="tingkatan"
                                                        @if (!empty($defaultTemplate) && $defaultTemplate->type == 'tingkatan') selected @endif>Tingkatan
                                                    </option>
                                                    <option value="jurusan"
                                                        @if (!empty($defaultTemplate) && $defaultTemplate->type == 'jurusan') selected @endif> Jurusan </option>
                                                </select>
                                                @error('template_type')
                                            ...
                                            <div class="col-lg-4">
                                                <select name="id_school_year_" class="form-control">
                    ...
                    <form action="{{ route('templates.updateOrCreate') }}" method="post" class="formx" name="formx">
                        @csrf
                                    ...
                                    <tbody>
                                        @foreach ($templates as $index => $template)
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" name="template_types[]"
                                                        value="{{ $template['type_template_default'] }}">
                        ...
                        @if (!empty($defaultTemplate))
                            <div class="account-settings-footer">
                                ...
                                <div class="as-footer-container">
                                    ...
                                    <button class="btn btn-primary" id="btnSubmit" type="submit">Simpan
                                        Data</button>
