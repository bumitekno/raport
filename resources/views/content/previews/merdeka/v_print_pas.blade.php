        ...
        <tbody>
            ...
            @else
                @foreach ($result_score as $score)
                    ...
                    <td>
                        <p>Menunjukan penguasaan yang baik dalam {{ implode(', ', $score['competence_archieved']) }}
                        </p>
                        <p>Perlu ditingkatkan untuk {{ implode(', ', $score['competency_improved']) }}
                        </p>
                    </td>
                @endforeach
            @endif
            ...
            <tr>
                <td colspan="3" class="b-0" style="padding: 0px !important">
                    <table class="table">
                        <tr>
                            <td class="b-0" colspan="2" style="font-size: 12pt">C. KETIDAK HADIRAN</td>
                        </tr>
                        <tr>
                            <td>
                                Sakit</td>
