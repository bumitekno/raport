                                                ...
                                                <div class="d-sm-flex d-block">
                                                    <div class="form-group mr-1">
                                                        <select class="form-control" name="day"
                                                            ...
                                                            @for ($i = 1; $i <= 31; $i++)
                                                                <option value="{{ $i }}"
                                                                    {{ isset($user) && old('day', $user->date_of_birth->format('d')) == $i ? 'selected' : (old('day') == $i ? 'selected' : '') }}>
                                                                    {{ $i }}
                                                                </option>
                                                            @endfor
                                                        </select>
                                                    ...
                                                    <div class="form-group mr-1">
                                                        <select class="form-control" name="month">
                                                            ...
                                                            <option value="01"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '01' ? 'selected' : (old('month') == '01' ? 'selected' : '') }}>
                                                                Januari</option>
                                                            <option value="02"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '02' ? 'selected' : (old('month') == '02' ? 'selected' : '') }}>
                                                                Februari</option>
                                                            <option value="03"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '03' ? 'selected' : (old('month') == '03' ? 'selected' : '') }}>
                                                                Maret</option>
                                                            <option value="04"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '04' ? 'selected' : (old('month') == '04' ? 'selected' : '') }}>
                                                                April</option>
                                                            <option value="05"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '05' ? 'selected' : (old('month') == '05' ? 'selected' : '') }}>
                                                                Mei</option>
                                                            <option value="06"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '06' ? 'selected' : (old('month') == '06' ? 'selected' : '') }}>
                                                                Juni</option>
                                                            <option value="07"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '07' ? 'selected' : (old('month') == '07' ? 'selected' : '') }}>
                                                                Juli</option>
                                                            <option value="08"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '08' ? 'selected' : (old('month') == '08' ? 'selected' : '') }}>
                                                                Agustus</option>
                                                            <option value="09"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '09' ? 'selected' : (old('month') == '09' ? 'selected' : '') }}>
                                                                September</option>
                                                            <option value="10"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '10' ? 'selected' : (old('month') == '10' ? 'selected' : '') }}>
                                                                Oktober</option>
                                                            <option value="11"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '11' ? 'selected' : (old('month') == '11' ? 'selected' : '') }}>
                                                                November</option>
                                                            <option value="12"
                                                                {{ isset($user) && old('month', $user->date_of_birth->format('m')) == '12' ? 'selected' : (old('month') == '12' ? 'selected' : '') }}>
                                                                Desember</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group mr-1">
                                                        <select class="form-control" name="year">
                                                            ...
                                                            @for ($year = $current_year; $year >= $start_year; $year--)
                                                                <option value="{{ $year }}"
                                                                    {{ isset($user) && old('year', $user->date_of_birth->format('y')) == $year ? 'selected' : (old('year') == $year ? 'selected' : '') }}>
                                                                    {{ $year }}
                                                                </option>
                                                            @endfor
                                                        </select>
    ...
    @push('scripts')
        ...
        <script>
            $(function() {
                ...
                // var blank_line = $('.edu-section').clone();
                // $('#add-education').click(function() {

                //     $('.form-parent').append(blank_line.clone())
