...
Route::prefix('master')->name('master')->group(function (){
    Route::prefix('extracurriculars')->name('extracurriculars')->group(function (){
        ...
        Route::delete('{key}', [ExtracurricularController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::prefix('school_years')->name('school_years')->group(function (){
        ...
        Route::delete('{key}', [SchoolYearController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::prefix('majors')->name('majors')->group(function (){
        ...
        Route::delete('{key}', [MajorController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::prefix('levels')->name('levels')->group(function (){
        ...
        Route::delete('{key}', [LevelController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::prefix('study_classes')->name('study_classes')->group(function (){
        ...
        Route::delete('{key}', [StudyClassController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::prefix('courses')->name('courses')->group(function (){
        ...
        Route::delete('{key}', [CourseController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::prefix('student_classes')->name('student_classes')->group(function (){
        ...
        Route::delete('{key}', [StudentClassController::class, 'destroy'])->name('destroy');
    });
    ...
    Route::prefix('subject_teachers')->name('subject_teachers')->group(function (){
        ...
        Route::delete('{key}', [SubjectTeacherController::class, 'destroy'])->name('destroy');
    });
